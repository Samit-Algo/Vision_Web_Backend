...
Track: one tracked object (bbox, center, history, velocity).
SimpleTracker: match detections to tracks (IoU + velocity prediction), used by class_count/box_count.
LineCrossingCounter: count crossings of a line (entry/exit, side1/side2).
"""
...
# -----------------------------------------------------------------------------
# Multi-object tracker (IoU + velocity prediction + fallback distance)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Line crossing counter (entry/exit, side1/side2, count once per track)
# -----------------------------------------------------------------------------
